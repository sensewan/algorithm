...
from NFT_INFO_DIGITAL where NID_NO = '690';
select NID_NO, GCODE, BLOCKCHAIN_OK, TOKEN_ID, TI_NO, SELLED, OWN_MEMBR_PK, NFT_ADDR_CHANGE_STAT, OWNER
...
select INDEX_NO, OD_ID, GCODE, GOODSTYPE, MEMBR_PK, GS_ID, NID_NO, GRID_NO, JOINT_NO, PAY_TYPE, PAYMETHOD, SALE_TYPE, DAN from NFT_ORDER where NID_NO ='690';
